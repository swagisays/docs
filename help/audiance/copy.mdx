...
<CardGroup>
  ...
  <Card title="Required 'EMAIL' Column" icon="at">
    Your data **must** include a column header and data for `EMAIL`. This is essential for identifying and managing your contacts.
  </Card>
