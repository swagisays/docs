...
<Step title="2. Designing the Flow (Adding Nodes)">
  ...
  - **Select Template:** In the pop-up, choose the email template for this step from the dropdown. You should create your templates beforehand in the [Templates](/templates/email-list) section.
