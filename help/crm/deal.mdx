...
icon: 'handshake'
---
**Want to Manage Deals? [Go to the AdsEra Deal Page &rarr;](https://app.adsera.in/dashboard/crm/deal)**

The **Deals** page is the heart of your CRM, providing a visual representation of your sales process. Here, you can track the progress of each sales opportunity (a "deal") as it moves through the stages of your [Pipelines](/help/crm/pipeline), from initial contact to a final win or loss.
...
- **Total & Weighted Value:** At the bottom of each column, you'll find:
    ...
    - **Weighted:** The total value multiplied by the stage's win probability (set in the [Pipeline settings](/help/crm/pipeline)). This provides a forecast of expected revenue.
...
![The Create/Edit Deal side panel.](https://sgp1.digitaloceanspaces.com/whatsera/4ed0d9ed-9bc3-4544-b1ff-c8a13987183e_deal_edit.png)
...
<AccordionGroup>
  ...
  <Accordion title="Products & Value">
    ...
    3.  Choose a product from your [Product Catalog](/help/crm/product).
