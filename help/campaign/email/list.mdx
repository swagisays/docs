...
**Want to Manage Email Campaigns? [Go to the AdsEra Email Campaign Page &rarr;](https://app.adsera.in/dashboard/campaign/mail/list)**
...
<Info>
  **Dedicated IP Required:** You can only send email campaigns from a dedicated IP address. AdsEra does not permit sending campaigns without one to protect deliverability for all users. To acquire a dedicated IP, please [Contact Us](https://adsera.in/contact-us).
</Info>
...
<AccordionGroup>
  <Accordion title="Creating a New Campaign">
    ...
    For a full walkthrough, see our guide on [Creating an Email Campaign](/help/campaign/email/create).
  </Accordion>
  <Accordion title="Viewing a Detailed Report">
    ...
    Learn more in our guide to [Analyzing Campaign Reports](/help/campaign/email/report).
  </Accordion>
