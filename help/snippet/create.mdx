...
**Want to create Snippets? [Go to the AdsEra Snippet Create Page &rarr;](https://app.adsera.in/dashboard/snippets/create)**
...
After navigating to the [Snippets](https://app.adsera.in/dashboard/snippets/list) page and clicking **"+ Create Snippet"**, you will be guided through the following steps.
...
<Step title="3. Finalize and Create">
  ...
  Once you are satisfied with your snippet, click the **"Create"** button at the bottom to save it to your library. It will now be available for your agents to use in the [WhatsApp Chat Inbox](/help/inbox/chat).
</Step>
</Steps>