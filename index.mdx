...
<Card title="Creatung an AdsEra account" icon="user-beard-bolt" iconType="regular">
  Creating an organization & settong up you AdsEra account.
</Card>

<Card title="Pre requirements" icon="code-pull-request" iconType="regular">
  Check some required things before you setup the AdsEra account.
</Card>

## Connect Channels

<Card title="New Card" icon="sparkles" img="https://storage.whatsera.com/Group%20517%20(1).png">
